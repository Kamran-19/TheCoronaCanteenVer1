...
public class employeeinfo {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_5 = new JLabel("FLAG");
		lblNewLabel_1_5.setFont(new Font("Arial", Font.BOLD, 20));
		lblNewLabel_1_5.setBounds(883, 124, 57, 40);
		...
		String name,firstname,lastname,dateofbirth,emailid,attendancevalue,flagvalue;
		...
		while(sc.hasNextLine())
		{
			...
			JLabel flag = new JLabel(flagvalue);
			flag.setBounds(895, fl, 39, 20);
			frmEmployeeInformationTable.getContentPane().add(flag);
			fl+=40;
